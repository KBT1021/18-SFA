...
public class Hologram : MonoBehaviour 
{
    ...
    void CameraRect(Vector2 res)
    {
        ...
        cameras[1].rect = new Rect(1 / 2f - cameraCenterX, 1 / 2f - (3 * cameraCenterY)+1/2f*cameraCenterY, cameraSizeX, cameraSizeY);
        cameras[2].rect = new Rect(1 / 2f - cameraCenterX, 1 / 2f + cameraCenterY-1/2f*cameraCenterY, cameraSizeX, cameraSizeY);

        if (type == Direction.topDown)
        {
            cameras[3].rect = new Rect(1 / 2f - (3 * cameraCenterX)+1/2f*cameraCenterX, 1 / 2f - cameraCenterY, cameraSizeX, cameraSizeY);
            cameras[4].rect = new Rect(1 / 2f + cameraCenterX-1/2f*cameraCenterX, 1 / 2f - cameraCenterY, cameraSizeX, cameraSizeY);
        }
        else if (type == Direction.bottomUp)
        {
            cameras[3].rect = new Rect(1 / 2f + cameraCenterX-1/2f*cameraCenterX, 1 / 2f - cameraCenterY, cameraSizeX, cameraSizeY);
            cameras[4].rect = new Rect(1 / 2f - (3 * cameraCenterX)+1/2f*cameraCenterX, 1 / 2f - cameraCenterY, cameraSizeX, cameraSizeY);
        }
    }
